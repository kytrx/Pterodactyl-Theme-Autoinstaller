...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY YSSHstore           [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "YogzVPN" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke YSSHstore${NC}"
    echo -e "${YELLOW}TELEGRAM : @YSSHstore${NC}"
    echo -e "${YELLOW}WHATSAPP : 6281215360549${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 25K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©YSSHstore${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer YSSHstore Private   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : t.me/YSSHstore     ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : YSSHstore ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by YSSHstore X Amalia  ${NC}"
